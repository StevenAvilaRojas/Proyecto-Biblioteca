...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { article_id: @participant.article_id, author_id: @participant.author_id } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { article_id: @participant.article_id, author_id: @participant.author_id } }
